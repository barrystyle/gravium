...
public:
    CMainParams()
    {
        ...
        consensus.nStakeTargetSpacing = 2.5 * 60;
        consensus.nTargetSpacingWorkMax = 12 * consensus.nStakeTargetSpacing;
        consensus.nPowTargetTimespan = 16 * 60;    // every 16 blocks
        consensus.nPowTargetSpacing = 1 * 60;      // 60s spacing
        consensus.nStakeMinAge = 60 * 60 * 24 * 2;
        consensus.nStakeMaxAge = 60 * 60 * 24 * 365 * 65;
        consensus.nModifierInterval = 3 * 60 * 60;
        ...
        vSeeds.push_back(CDNSSeedData("dnsseed_au1.gravium.io", "dnsseed_au1.gravium.io"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
                (0,     uint256S("0x0000057ba8da1da1e9e83128ada30f99d1135b58c57b7c0f8188155b6fb04969"))
                (16666, uint256S("0x000000002988a065ccf0311515b8c26003864e299de5d8cab6c4d818ef711f28"))
                (22666, uint256S("0x00000000005705ef49c57f61246abebf280172bae1b36d58e7a9ec9a866d7f3a")),
            1528585728,   // * UNIX timestamp of last checkpoint block
...
public:
    CTestNetParams()
    {
        ...
        consensus.powLimit = uint256S("00000fffff000000000000000000000000000000000000000000000000000000");
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Gravium: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60;      // Gravium: 2.5 minutes
        ...
        // Testnet Gravium addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 55);
        // Testnet Gravium script addresses start with '8' or '9'
        ...
        // Testnet Gravium BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Gravium BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet Gravium BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of(0, uint256S("0x00000eeaea534b8755f38b087db2cf7751b0ba1d8620e9ed0938d94874f18f81")),
...
public:
    CRegTestParams()
    {
        ...
        checkpointData = (CCheckpointData){
            ...
            0,
            0};
        // Regtest Gravium addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 140);
        // Regtest Gravium script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);
        // Regtest Gravium BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest Gravium BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest Gravium BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
    }
};
